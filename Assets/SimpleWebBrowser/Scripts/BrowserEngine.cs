...
namespace SimpleWebBrowser
{
    ...
    public class BrowserEngine
    {
        ...
        public IEnumerator InitPlugin(int width, int height, string sharedfilename,string initialURL,bool enableWebRTC,bool enableGPU) {
            _localhostname = UnityEngine.Networking.UnityWebRequest.EscapeURL(sharedfilename);
        ...
        string PluginServerPath=AssemblyPath+@"\PluginServer";
           ...
           _connected = false;
            ...
            while (!_connected)
            {
                ...
                {
                    Debug.Log("FAILED TO START SERVER FROM:" + PluginServerPath + @"\SharedPluginServer.exe - "+ex.Message);
                    throw;
                }
